 ...
 */
public class System {
    //public static PrintStream out = null;// = new PrintStream(new JSConsole.log.Stream());
    //public static PrintStream err = null;// = new PrintStream(new JSConsole.error.Stream());
