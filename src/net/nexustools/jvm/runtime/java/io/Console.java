...
import net.nexustools.jvm.runtime.java.util.*;
 ...
 * {@link net.nexustools.jvm.runtime.java.lang.System#console()} method.  If no console device is
 ...
 *     ...
 *     net.nexustools.jvm.runtime.java.util.Arrays.fill(passwd, ' ');
 * }
 * </pre></blockquote>
 *
 * @author  Xueming Shen
...
{
   /**
    * Retrieves the unique {@link net.nexustools.jvm.runtime.java.io.PrintWriter PrintWriter} object
   ...
   /**
    * Retrieves the unique {@link net.nexustools.jvm.runtime.java.io.Reader Reader} object associated
    * with this console.
    * <p>
    * This method is intended to be used by sophisticated applications, for
    * example, a {@link net.nexustools.jvm.runtime.java.util.Scanner} object which utilizes the rich
    ...
    * <tt>{@link #readLine}</tt>.
    * <p>
    * The bulk read operations {@link net.nexustools.jvm.runtime.java.io.Reader#read(char[]) read(char[]) },
    * {@link net.nexustools.jvm.runtime.java.io.Reader#read(char[], int, int) read(char[], int, int) } and
    * {@link net.nexustools.jvm.runtime.java.io.Reader#read(java.nio.CharBuffer) read(java.nio.CharBuffer)}
