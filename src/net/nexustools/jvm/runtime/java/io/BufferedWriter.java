...
public class BufferedWriter extends java.io.Writer {
    ...
    /**
     * Our own little min method, to avoid loading net.nexustools.jvm.runtime.java.lang.Math if we've run
     ...
     * method in the {@linkplain net.nexustools.jvm.runtime.java.io.Writer#write(java.lang.String,int,int)
